 ...
 */
export function roomlessVirtualSwitch(
  client?: st.SmartThingsClient
): RoomlessVirtualSwitch.Device {
  ...
  export namespace Components {
    export namespace Main {
      ...
      export class Component extends stgen.Component<Status, Device> {
         ...
         */
        readonly actuator = new capabilities.Actuator.v1.Capability<
          Component,
          Device
        >(this);
         ...
         */
        readonly healthcheck = new capabilities.Healthcheck.v1.Capability<
          Component,
          Device
        >(this);
         ...
         */
        readonly relayswitch = new capabilities.Relayswitch.v1.Capability<
          Component,
          Device
        >(this);
         ...
         */
        readonly sensor = new capabilities.Sensor.v1.Capability<
          Component,
          Device
        >(this);
         ...
         */
        readonly switch = new capabilities.Switch.v1.Capability<
          Component,
          Device
        >(this);
      }
 ...
 * @param client a SmartThingsClient.  If none is provided, uses the default set using {@link module:stgen.setDefaultClient}
 */
export function virtualDimmer(
  client?: st.SmartThingsClient
): VirtualDimmer.Device {
  ...
  export namespace Components {
    export namespace Main {
      ...
      export class Component extends stgen.Component<Status, Device> {
         ...
         */
        readonly configuration = new capabilities.Configuration.v1.Capability<
          Component,
          Device
        >(this);
         ...
         */
        readonly refresh = new capabilities.Refresh.v1.Capability<
          Component,
          Device
        >(this);
         ...
         */
        readonly switchlevel = new capabilities.Switchlevel.v1.Capability<
          Component,
          Device
        >(this);
      }
 ...
 * @param client a SmartThingsClient.  If none is provided, uses the default set using {@link module:stgen.setDefaultClient}
 */
export function virtualWindowShade(
  client?: st.SmartThingsClient
): VirtualWindowShade.Device {
  ...
  export namespace Components {
    export namespace Main {
      ...
      export class Component extends stgen.Component<Status, Device> {
         ...
         */
        readonly windowshade = new capabilities.Windowshade.v1.Capability<
          Component,
          Device
        >(this);
